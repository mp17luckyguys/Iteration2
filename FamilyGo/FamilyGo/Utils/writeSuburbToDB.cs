    ...
    public class WriteSuburbToDB
    {
        ...
        { 
            public void Page_Load()
            {
                ...
                System.Data.DataTable dt = fileSvr.GetExcelDatatable("E:\\MIT\\5120\\Project\\data\\suburb.xls", "suburb");
        ...
        class FileSvr
        {
            ...
            public int InsetData(System.Data.DataTable dt)
            {
                ...
                {
                    suburb = dr["suburb"].ToString().Trim();
                    var geocoder = new Geocoder("AIzaSyDJeTABC7AwjSI-x7dm2cVlbHvA3yN65HA");
                    var locations = geocoder.Geocode(suburb + ",VIC,Australia");
                    if (locations.Count() != 0)
                    {
                        ...
                        string strSql = string.Format("Insert into Suburbs (SuburbName,Lat,Lon) Values ('{0}','{1}','{2}')", suburb,lat, lon);
